...
export const CarrierIntelligenceCard: React.FC<CarrierCardProps> = ({ ipData, ip }) => {
  ...
  return (
    <div className="glass-card animate-fade-in-up" style={{ padding: '28px', borderColor: 'rgba(0,242,255,0.3)', borderLeft: '4px solid var(--primary)' }}>
      {/* Top Badge & Carrier Header */}
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px', marginBottom: '24px' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
            <span style={{ padding: '3px 10px', borderRadius: '999px', background: 'rgba(0,242,255,0.12)', border: '1px solid rgba(0,242,255,0.35)', color: 'var(--primary)', fontFamily: 'var(--font-mono)', fontSize: '11px', fontWeight: 700, letterSpacing: '0.05em' }}>
      ...
      {/* Notice Banner */}
      <div style={{ padding: '12px 16px', borderRadius: '8px', background: 'rgba(0,242,255,0.04)', border: '1px solid rgba(0,242,255,0.15)', marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '12px' }}>
