    ...
    <div style={{ background: '#111927', border: '1px solid #1e293b', borderRadius: '10px', padding: '28px 32px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #1e293b', paddingBottom: '16px', flexWrap: 'wrap', gap: '12px' }}>
        ...
        <div style={{
          ...
          <span className="material-symbols-outlined" style={{ color: '#00ffa3', fontSize: '18px' }}>verified</span>
          <span style={{ color: '#00ffa3', fontSize: '12px', fontWeight: 700, fontFamily: 'var(--font-mono)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '14px' }}>
        ...
        <div style={{ background: 'rgba(0,0,0,0.25)', border: '1px solid #1e293b', borderRadius: '8px', padding: '14px 18px' }}>
          ...
          <div style={{ fontSize: '14px', fontWeight: 600, color: '#00ffa3', marginTop: '4px' }}>
        ...
        <div style={{ background: 'rgba(0,0,0,0.25)', border: '1px solid #1e293b', borderRadius: '8px', padding: '14px 18px' }}>
          ...
          <div style={{ fontSize: '14px', fontWeight: 600, color: report.mitigations.canary ? '#00ffa3' : '#ff2a5f', marginTop: '4px' }}>
      ...
      <div style={{ background: 'rgba(0,0,0,0.25)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '8px', padding: '16px 20px' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
          {report.dynamicLibraries.map((lib, idx) => (
            <span key={idx} style={{ fontSize: '12px', fontFamily: 'var(--font-mono)', color: '#38bdf8', background: 'rgba(56,189,248,0.08)', border: '1px solid rgba(56,189,248,0.2)', padding: '4px 10px', borderRadius: '6px' }}>
              📚 {lib}
            </span>
          ))}
        </div>
