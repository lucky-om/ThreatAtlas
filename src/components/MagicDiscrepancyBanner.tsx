    ...
    <div style={{
      ...
      <div style={{ flex: 1 }}>
        ...
        <div style={{ fontSize: '12px', color: '#cbd5e1', lineHeight: 1.5 }}>
          {discrepancy.explanation} (Declared Extension: <strong style={{ color: '#ff2a5f' }}>.{discrepancy.declaredExtension}</strong> ➔ Actual Content: <strong style={{ color: '#00f2ff' }}>{discrepancy.actualFileType}</strong>)
        </div>
      </div>
    </div>
  );
