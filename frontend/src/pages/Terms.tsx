    ...
    <div className="module-page">
      ...
      <div className="container" style={{ position: 'relative', zIndex: 10, maxWidth: '1280px', width: '100%' }}>
        ...
        <div className="module-hero" style={{ textAlign: 'left', marginBottom: '32px' }}>
          ...
          <AnimatedTitle
            text={<span>ThreatAtlas <span style={{ color: "var(--brand)" }}>Terms of Service</span></span>}
            as="h1"
        ...
        {/* Warning Callout Box */}
        <div className="glass-card animate-fade-in-up" style={{ padding: '20px 24px', marginBottom: '32px', borderLeft: '4px solid var(--primary)', background: 'rgba(255, 107, 53,0.04)' }}>
