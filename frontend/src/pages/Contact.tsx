...
export const Contact: React.FC = () => {
  ...
  return (
    <div className="module-page">
      <SEO
        title="Contact Us"
        description="Get in touch with the ThreatAtlas security team for support, feedback or inquiries."
        path="/contact"
      />
      
      <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0, background: 'radial-gradient(circle at 50% 30%, rgba(255, 107, 53,0.06) 0%, transparent 60%)' }} />

      <div className="container" style={{ position: 'relative', zIndex: 10, maxWidth: '1000px', width: '100%' }}>
        
        {/* Header */}
        <div className="module-hero">
          <div className="module-badge" style={{ background: 'rgba(232,25,44,0.12)', border: '1px solid rgba(232,25,44,0.35)', color: 'var(--primary)' }}>
            <span className="material-symbols-outlined" style={{ fontSize: '14px' }}>support_agent</span>
            Support & Inquiries
          </div>
          <AnimatedTitle
            text={<span>Contact <span style={{ color: "var(--brand)" }}>ThreatAtlas</span> Team</span>}
            as="h1"
            style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(34px, 5.5vw, 52px)', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.05, marginBottom: '12px', color: 'var(--text)' }}
          />
          <motion.p
            initial={{ opacity: 0, y: 12, filter: 'blur(6px)' }}
            animate={{ opacity: 1, y: 0, filter: 'blur(0px)' }}
            transition={{ delay: 0.35, duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
            className="font-body-md text-on-surface-variant" style={{ maxWidth: '600px', margin: '0 auto' }}
          >
            ...
            <div className="glass-card animate-fade-in-up" style={{ padding: '24px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div>
                  ...
                  <div className="font-code-sm text-on-surface-variant" style={{ fontSize: '12px' }}>
                    Files and URLs scanned via threat intelligence APIs become part of the global threat intelligence ecosystem to help the cybersecurity community detect zero-days.
                  </div>
                </div>
              </div>
            </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <div>
                    ...
                    <div className="font-code-sm text-on-surface-variant" style={{ fontSize: '12px' }}>
                      <a href="mailto:omp48095@gmail.com" style={{ color: 'var(--primary)', textDecoration: 'none' }}>omp48095@gmail.com</a>
                    </div>
                  </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
