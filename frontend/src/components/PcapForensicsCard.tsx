    ...
    <div style={{ background: '#111927', border: '1px solid #1e293b', borderRadius: '10px', padding: '28px 32px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #1e293b', paddingBottom: '16px', flexWrap: 'wrap', gap: '12px' }}>
        ...
        <div style={{
          ...
          <span className="material-symbols-outlined" style={{ color: 'var(--brand)', fontSize: '18px' }}>check_circle</span>
          <span style={{ color: 'var(--brand)', fontSize: '12px', fontWeight: 700, fontFamily: 'var(--font-mono)' }}>
            PCAP Stream Normal
          </span>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '14px' }}>
        ...
        <div style={{ background: 'rgba(0,0,0,0.25)', border: '1px solid #1e293b', borderRadius: '8px', padding: '14px 18px' }}>
          ...
          <div style={{ fontSize: '15px', fontWeight: 700, color: 'var(--brand)', marginTop: '4px', fontFamily: 'var(--font-mono)' }}>
        ...
        <div style={{ background: 'rgba(0,0,0,0.25)', border: '1px solid #1e293b', borderRadius: '8px', padding: '14px 18px' }}>
          ...
          <div style={{ fontSize: '14px', fontWeight: 600, color: report.cleartextCredentialsDetected ? '#ff2a5f' : 'var(--brand-amber)', marginTop: '4px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {report.protocols.map((p, i) => (
              <div key={i} style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', fontFamily: 'var(--font-mono)' }}>
                ...
                <span style={{ color: 'var(--brand)', fontWeight: 700 }}>{p.percentage}%</span>
              </div>
            ))}
          </div>
        </div>
