...
async function lookupVt(ioc: IocEntry): Promise<Partial<IocResult>> {
  try {
    ...
    if (apiKey) headers.set('x-apikey', apiKey);
...
export const BulkIocModule: React.FC = () => {
  ...
  return (
    <div style={{ marginTop: '24px', padding: '24px', background: 'rgba(255,255,255,0.02)', borderRadius: '12px', border: '1px solid rgba(255, 69, 0,0.2)' }}>
