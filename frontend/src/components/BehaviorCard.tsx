    ...
    <div style={{ borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '16px' }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <span style={{ fontSize: '12px', padding: '1px 8px', background: 'rgba(255, 107, 53,0.15)', border: '1px solid rgba(255, 107, 53,0.3)', borderRadius: '999px', color: 'var(--primary)', fontFamily: 'var(--font-mono)' }}>
            {count}
          </span>
        </div>
      ...
      {uniqueMitre.length > 0 && (
        <div className="glass-card animate-fade-in-up" style={{ padding: '32px' }}>
          <h3 className="font-headline-sm text-on-surface" style={{ marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontSize: '12px', padding: '2px 10px', background: 'rgba(255, 107, 53,0.15)', border: '1px solid rgba(255, 107, 53,0.3)', borderRadius: '999px', color: 'var(--primary)', fontFamily: 'var(--font-mono)' }}>
          ...
          <div key={idx} className="glass-card animate-fade-in-up" style={{ padding: '32px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              ...
              <Section icon="lock" title="Mutexes Created" count={mutexes.length}>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                  {mutexes.map((m, i) => <Pill key={i} color="rgba(255, 107, 53,0.06)">{m}</Pill>)}
                </div>
              </Section>
            </div>
          </div>
